/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: dc9ea50a81102b31aa09ceff6ee2164f)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ALLOWED_MODELS: "google:gemini-2.5-flash,google:gemini-2.5-pro,google:gemini-3-flash-preview,google:gemini-3-pro-preview";
		ADMIN_ENABLED: "0";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_MODEL" | "ALLOWED_MODELS" | "ADMIN_ENABLED">> {}
}
